...
(function () {
  ...
  var modalHTML = [
    ...
    '        <input class="modal-input" id="contact-name" name="from_name" type="text" autocomplete="name" required aria-required="true" aria-describedby="name-error" />',
    ...
    '        <input class="modal-input" id="contact-email" name="from_email" type="email" autocomplete="email" required aria-required="true" aria-describedby="email-error" />',
    ...
    '        <textarea class="modal-input modal-textarea" id="contact-message" name="message" rows="5" required aria-required="true" aria-describedby="message-error"></textarea>',
